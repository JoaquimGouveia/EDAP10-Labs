...
public class Factorizer {
    ...
    public static String crack(String ciphertext, BigInteger n, ProgressTracker tracker) throws InterruptedException {
        var primeFactors = new ArrayList<BigInteger>();
        ...
        while (k.compareTo(sqrtN) <= 0) {
            ...
            // Check interruption status. If the thread has been interrupted,
            // throw an InterruptedException, so it can be handled by the
